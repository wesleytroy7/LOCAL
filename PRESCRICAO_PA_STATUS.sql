...
--)
--AS 
WITH CURRENT_STATUS	AS ( /*CTE DE STATUS CORRENTE*/


	SELECT -- O ULTIMO STATUS PARA O CLIENTE
		DISTINCT
 ...
 CURRENT_PRESC AS ( /*CTE DE PRESCRICAO CORRENTE*/
...
WHERE
(
TBCLINICA.COD = 'S' /* CLINICA PA OU CDC PA*/
		OR
RECADATE.CDC = 20)
AND
...
WHERE 
  TBFLUXOATEND.ACAO NOT SIMILAR TO 'L'/* ENQUANTO PACIENTE NÃO FOR LIBERADO*/
